# AUTOSCRIPT BY VPN JIE

 <h2 align="center">AutoScript Install VPN By JIE<img src="https://img.shields.io/badge/Version-1-blue.svg"></h2>
...
## Installation
  ...
  ```html
  sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && sudo apt install -y wget && sudo apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/jielenovo/com/main/setup.sh && chmod +x setup.sh && ./setup.sh && rm -rf ./setup.sh
